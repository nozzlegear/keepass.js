...
describe("kdbx", function () {
    it("should decrypt a kdbx file properly", function (done) {
        loadFile('base/test/data/database_simple.kdbx.dat', function (fileContents) {
    ...
    it("should decrypt a kdbx file protected with xml keyfile properly", function (done) {
         loadFile('base/test/data/database_with_xml_keyfile.kdbx.dat', function (fileContents) {
             loadFile('base/test/data/key_file_xml.dat', function (keyFile) {
                 var keepass = new Keepass.Database();
    ...
    it("should decrypt a kdb file properly", function (done) {
         loadFile('base/test/data/database_simple.kdb.dat', function (fileContents) {
             var keepass = new Keepass.Database();
